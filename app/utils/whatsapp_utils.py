...
async def process_whatsapp_message(body):
    ...
    try:
        ...
        start_time = time(10, 0, 0)   # 8:00 AM
        ...
        # if True:
           ...
           if message["type"] == "interactive" and "button_reply" in message["interactive"]:
                ...
                # response = "ക്ഷമിക്കണം 🙏\nഞങ്ങളുടെ ആപ്പ് നിലവിൽ മെന്റനൻസിലായതിനാൽ താൽക്കാലികമായി ലഭ്യമല്ല 🛠️\nനാളെ രാവിലെ മുതൽ ആപ്പ് വീണ്ടും ലഭ്യമാകും.\nദയവായി പിന്നീട് വീണ്ടും ശ്രമിക്കുക. 😊\n\nഅത്യാവശ്യങ്ങൾക്കായി ബന്ധപ്പെടുക: +91 99615 75781"

                
                response = "ക്ഷമിക്കണം, സ്റ്റോർ ഇപ്പോൾ അടച്ചിരിക്കുന്നു 🔒\nഞങ്ങളുടെ പ്രവർത്തന സമയം രാവിലെ 10 മണി മുതൽ രാത്രി 10 മണി വരെയാണ്.\nഈ സമയത്തിനുള്ളിൽ വീണ്ടും ഷോപ്പിംഗ് ചെയ്യൂ. 🛍️\n\nഅത്യാവശ്യങ്ങൾക്കായി: +91 99615 75781" 
